...
/**
   ...
   */
const BlockHeader = module.exports = function (data, opts) {
  opts = opts || {};
...
BlockHeader.prototype.canonicalDifficulty = function (parentBlock) {
  ...
  const offset = parentDif.div(new BN(this._common.param("pow", "difficultyBoundDivisor", hardfork)));
  ...
  if (this._common.hardforkGteHardfork(hardfork, "byzantium")) {
    ...
    const uncleAddend = parentBlock.header.uncleHash.equals(utils.SHA3_RLP_ARRAY) ? 1 : 2;
